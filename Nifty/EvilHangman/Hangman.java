...
public class Hangman {
  ...
  public static boolean checkName = false;  // check to loop a games
    ...
    while (isPlay == true) { // while user played
      while (checkLength == false) { // while user input length
        ...
        try{
          ...
          length = sc.nextInt(); // enter length
  ...
  public String showLetterGuess() {
    ...
    return letterGuessHistory; // return history
  }
